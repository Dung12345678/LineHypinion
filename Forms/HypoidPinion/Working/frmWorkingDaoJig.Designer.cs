namespace BMS
{
    partial class frmWorkingDaoJig
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colKnifeCodeTree = new DevExpress.XtraTreeList.Columns.TreeListColumn();
            ...
            this.colIDTree,
            this.colKnifeName,
            this.colKnifeCodeTree,
            this.colParentID});
			this.treeData.Location = new System.Drawing.Point(6, 51);
			...
			this.treeData.Size = new System.Drawing.Size(346, 485);
			...
			this.colKnifeName.ColumnEdit = this.repositoryItemMemoEdit2;
			this.colKnifeName.FieldName = "KnifeName";
			this.colKnifeName.Name = "colKnifeName";
			this.colKnifeName.OptionsColumn.AllowEdit = false;
			this.colKnifeName.OptionsColumn.AllowFocus = false;
			this.colKnifeName.OptionsColumn.AllowMove = false;
			this.colKnifeName.OptionsColumn.AllowSort = false;
			this.colKnifeName.Visible = true;
			this.colKnifeName.VisibleIndex = 1;
			this.colKnifeName.Width = 169;
			// 
			...
			// colKnifeCodeTree
			// 
			this.colKnifeCodeTree.AppearanceHeader.Font = new System.Drawing.Font("Tahoma", 8.25F, System.Drawing.FontStyle.Bold);
			this.colKnifeCodeTree.AppearanceHeader.Options.UseFont = true;
			this.colKnifeCodeTree.AppearanceHeader.Options.UseTextOptions = true;
			this.colKnifeCodeTree.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
			this.colKnifeCodeTree.Caption = "Mã dụng cụ";
			this.colKnifeCodeTree.FieldName = "KnifeCode";
			this.colKnifeCodeTree.Name = "colKnifeCodeTree";
			this.colKnifeCodeTree.OptionsColumn.AllowEdit = false;
			this.colKnifeCodeTree.OptionsColumn.AllowFocus = false;
			this.colKnifeCodeTree.Visible = true;
			this.colKnifeCodeTree.VisibleIndex = 0;
			this.colKnifeCodeTree.Width = 134;
			// 
			// colParentID
			// 
            ...
            "Jig",
            "Khuôn"});
			this.cboLoai.Location = new System.Drawing.Point(53, 12);
			this.cboLoai.Name = "cboLoai";
			this.cboLoai.Size = new System.Drawing.Size(279, 21);
			...
			this.Text = "DANH SÁCH MỤC KIỂM TRA THEO LOẠI DAO && JIG && KHUÔN";
		...
		private DevExpress.XtraTreeList.Columns.TreeListColumn colKnifeCodeTree;
