namespace BMS
{
    partial class frmProceductionPlan
    {
        ...
        private void InitializeComponent()
        {
			...
			this.colAssembly.VisibleIndex = 2;
			...
			this.colRealQty.VisibleIndex = 9;
			// 
			// colSalesOrder
			// 
			...
			this.colSalesOrder.VisibleIndex = 11;
			...
			this.colRequestDate.VisibleIndex = 13;
			...
			this.colProductCodeNew.VisibleIndex = 18;
			// 
			// colNote
			// 
			...
			this.colMaMoto.VisibleIndex = 20;
			...
			this.colMaMoto1.VisibleIndex = 21;
			// 
			// colStatuss
			// 
			...
			this.colDeliveryDate.VisibleIndex = 22;
			...
			this.colAssemblyDate.VisibleIndex = 14;
			...
			this.colOrderNew.VisibleIndex = 17;
			// 
			// colPrints
			// 
			...
			this.colPrints.VisibleIndex = 23;
			// 
